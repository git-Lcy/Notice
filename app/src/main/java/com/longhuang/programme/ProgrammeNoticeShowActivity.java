...
public class ProgrammeNoticeShowActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 铃声播放
        final String ringUrl = p.getRingingUrl();

        mBuilder.append(ringUrl).append("\n");
        ...
        if (p.isRinging() && !TextUtils.isEmpty(ringUrl) && !ringUrl.equals("无")){
            ...
            if (!musicFile.exists()){
                ...
                mBuilder.append("音乐文件不存在:").append(ringUrl).append("\n");
                noticeInfo.setText(mBuilder.toString());
                return;
            }
            ...
            public void onClick(View v) {
                if (repeat==1){ // 重复则设置第二天的闹钟
                    ...
                    PendingIntent pendingIntent = PendingIntent
                            .getBroadcast(ProgrammeNoticeShowActivity.this,p.getRequestCode(),intent,PendingIntent.FLAG_ONE_SHOT);
