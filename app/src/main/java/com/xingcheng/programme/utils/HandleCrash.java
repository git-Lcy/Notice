...
public class HandleCrash implements Thread.UncaughtExceptionHandler {
    ...
    //CrashHandler实例
    private static HandleCrash INSTANCE = new HandleCrash();
    //程序的Context对象
    ...
    public static HandleCrash getInstance() {
        return INSTANCE;
    }
    ...
    private boolean handleException() {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                L.toast(mContext, "很抱歉,程序出现异常,即将退出...");
                Looper.loop();
  ...
  //          long timestamp = System.currentTimeMillis();
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path =  Environment.getExternalStorageDirectory().getPath()+"/ezplug/crash/";
